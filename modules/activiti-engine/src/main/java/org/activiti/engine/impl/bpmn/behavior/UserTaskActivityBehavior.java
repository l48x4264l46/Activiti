...
import org.activiti.engine.AssigneeType;
...
public class UserTaskActivityBehavior extends TaskActivityBehavior {
    ...
    public void execute(DelegateExecution execution) {
        ...
        Map<String, List<ExtensionAttribute>> attributes = null;

        ProcessEngineConfigurationImpl processEngineConfiguration = Context.getProcessEngineConfiguration();
        ExpressionManager expressionManager = processEngineConfiguration.getExpressionManager();
        attributes = userTask.getAttributes();
        ...
        if (StringUtils.isEmpty(activeTaskAssigneeType) && attributes != null) {
            ...
            if (CollectionUtil.isNotEmpty(extensionAttributes)) {
                for (ExtensionAttribute extensionAttribute : extensionAttributes) {
                    activeTaskAssigneeType = extensionAttribute.getValue();
                    break;
                }
            }
        }
